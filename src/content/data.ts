...
export const services: Service[] = [
  {
    ...
    useCaseDetails: ["A private pickup plan for travelers arriving at MCO, SFB or a requested Central Florida terminal.", "A scheduled ride that keeps the pickup, luggage and departure details in one confirmed plan.", "Private aviation requests can be reviewed with the terminal, timing and passenger details provided in advance."],
    faq: [
