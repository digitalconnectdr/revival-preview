...
export function PrimaryCta({ placement = "cta", label = "Book your ride", href }: { placement?: string; label?: string; href?: string }) { return <BookingLink className="button button-gold" href={href} placement={placement}>{label} <span aria-hidden="true">↗</span></BookingLink>; }
