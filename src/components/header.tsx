...
export function Header({ locale = "en" }: { locale?: Locale }) {
  ...
  return <header className="site-header">
    ...
    <div className="container nav-shell">
      <Link aria-label={copy.homeLabel} className="brand notranslate" data-no-translate href={localized("/")} onClick={() => setOpen(false)} translate="no"><span className="brand-mark">R</span><span><strong>Revival</strong><small>Transportation Group</small></span></Link>
